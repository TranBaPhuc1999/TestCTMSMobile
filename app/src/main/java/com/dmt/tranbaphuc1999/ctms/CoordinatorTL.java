...
class CoordinatorTabLayout extends CoordinatorLayout {
            ...
            public void onTabSelected(TabLayout.Tab tab) {
                ...
                mImageView.setOnClickListener(new OnClickListener() {
                    ...
                    public void onClick(View v) {
                        Toasty.warning(getContext(), "Chức năng chưa được xây dựng!", Toast.LENGTH_SHORT, true).show();
                    }
                });
            }
...
//    }
    ...
    public CoordinatorTabLayout setupWithViewPager(ViewPager viewPager) {
        ...
        setupTabLayout();
        mTabLayout.setSelectedTabIndicatorColor(getContext().getResources().getColor(R.color.colorPrimary));
    ...
    private void ChangeIconTabLayout(TabLayout.Tab tab) {
        if (tab.isSelected()==true) {
            if (mTabLayout.getSelectedTabPosition()==0) {
                tab.setIcon(R.drawable.icon_schedule_sub_blue);
                mTabLayout.getTabAt(1).setIcon(R.drawable.icon_monday_grey);
                mTabLayout.getTabAt(2).setIcon(R.drawable.icon_news_grey);
                setTitle("Thời khóa biểu");
            }
            if (mTabLayout.getSelectedTabPosition()==1) {
                mTabLayout.getTabAt(0).setIcon(R.drawable.icon_schedule_sub_grey);
                mTabLayout.getTabAt(2).setIcon(R.drawable.icon_news_grey);
                tab.setIcon(R.drawable.icon_monday_blue);
                setTitle("Lịch học");
            }
            if (mTabLayout.getSelectedTabPosition()==2) {
                tab.setIcon(R.drawable.icon_news_blue);
                mTabLayout.getTabAt(1).setIcon(R.drawable.icon_monday_grey);
                mTabLayout.getTabAt(0).setIcon(R.drawable.icon_schedule_sub_grey);
                setTitle("Tin tức");
            }
